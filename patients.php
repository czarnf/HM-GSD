...
$response = json_decode($controller->fetchAllPatient(), true);
    ...
    <div id="content">
      ...
      <div class="container mt-0">
        <div class="row breadcrumb-bar">
          <div class="col-md-6">
            <h3 class="block-title">Patients List</h3>
          </div>
          <div class="col-md-6">
            <ol class="breadcrumb">
                  ...
                  <tbody>
                    ...
                    ?>
                        <tr>
                          ...
                          <td> <a href="./team-members.php?id=<?php echo $patient["team_id"]; ?>" style="text-decoration: underline; color:green;"><?php echo $patient["team_name"]; ?></a></td>
                          <td>
