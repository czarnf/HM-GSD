...
if (isset($_GET["id"]) && strlen(trim($_GET["id"])) > 0) {
  ...
  $response = json_decode($controller->fetchPatientByWard($id), true);
    ...
    <div id="content">
      ...
      <div class="container mt-0">
        <div class="row breadcrumb-bar">
          <div class="col-md-6">
            <h3 class="block-title"><?php echo count($list) > 0 ? $list[0]["ward_name"] . " Patient List" : "Unidentified Patient List"; ?></h3>
          </div>
          <div class="col-md-6">
            <ol class="breadcrumb">
